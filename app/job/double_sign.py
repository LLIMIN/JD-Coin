...
class DoubleSign(Daka):
    ...
    index_url = 'https://ms.jr.jd.com/gw/generic/jrm/h5/m/getAwardList?_=' + str(int(time.time()))
    sign_url = 'https://ms.jr.jd.com/gw/generic/jrm/h5/m/getSignAwardJR?_=' + str(int(time.time()))
    test_url = index_url
